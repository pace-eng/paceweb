      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
        ...
        <div className="lg:col-span-3">
          ...
          >
            ...
            {/* 区域标题 */}
            <text x="25" y="40" className="text-sm font-bold fill-red-800">
              协作痛点
            </text>
            <text x="30" y="280" className="text-sm font-bold fill-green-800">
              PACE 双核心解决方案
            </text>
              ...
              return (
                <g key={challenge.id}>
                  ...
                  <g
                    ...
                    onClick={() => setActiveChallenge(activeChallenge === challenge.id ? null : challenge.id)}
                  >
                    <svg width="16" height="16" fill="white" stroke="white" strokeWidth="2">
                  ...
                  <text
                    ...
                    y={y + 35}
                    textAnchor="middle"
                    className="text-xs font-semibold fill-gray-800 cursor-pointer select-none"
                    onClick={() => setActiveChallenge(activeChallenge === challenge.id ? null : challenge.id)}
                  >
                    {challenge.title}
                  </text>
        ...
        <div className="lg:col-span-2">
          {activeChallenge ? (
            <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 transition-all duration-300 sticky top-4"
                  ...
                  <>
                    ...
                    <div className="space-y-4">
                      <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-300">
                        <h4 className="font-semibold text-red-900 mb-2">问题表现</h4>
                        <p className="text-red-700 text-sm mb-3">{challenge.problem}</p>
                        <div className="text-xs text-red-600 space-y-1">
                          <p>• 影响：导致项目延期、代码质量下降</p>
                          <p>• 频率：在AI协作中经常出现</p>
                        </div>
                      </div>
                      
                      <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-300">
                        <h4 className="font-semibold text-green-900 mb-2">PACE解决方案</h4>
                        <p className="text-green-700 text-sm mb-3">{challenge.solution}</p>
                      ...
                      <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                        <h4 className="font-semibold text-blue-900 mb-2">实践建议</h4>
                        <div className="text-xs text-blue-700 space-y-1">
                          {challenge.id === 'assumptions' && (
                            <>
                              <p>• 建立架构决策文档(ADR)</p>
                              <p>• 使用依赖关系图明确约束</p>
                              <p>• 定期架构审查和更新</p>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-lg p-6 text-center sticky top-4">
              <div className="text-blue-400 mb-4">
                <svg className="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-gray-700 mb-3">点击了解痛点</h3>
              <p className="text-gray-600 mb-4">选择上方的挑战圆圈，了解LLM协作编程中的具体问题和PACE的解决方案</p>
              
              <div className="bg-white rounded-lg p-4 mb-4">
                <h4 className="font-semibold text-gray-800 mb-2">PACE 1.3 亮点</h4>
                <div className="text-sm text-gray-600 space-y-1 text-left">
                  <p>• 双核心体系：Spec-Writing + Context Engineering</p>
                  <p>• 四大挑战系统性解决方案</p>
                  <p>• 与主流AI工具深度集成</p>
                  <p>• 企业级实践验证有效性</p>
                </div>
